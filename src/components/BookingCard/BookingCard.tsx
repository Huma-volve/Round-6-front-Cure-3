              ...
              <h2
                className={`${
                  filter === "canceled"
                    ...
                    ? "text-green-600"
                    : filter === "all"
                    ? "text-Background-Primary-Defult"
                    : filter === "upcoming"
                    ? "text-Background-Primary-Defult"
                    : ""
                }`}
            ...
            <>
              <div className="flex justify-between gap-2 mt-2">
                <button
                  ...
                  className="px-4 py-2 w-full rounded-xl cursor-pointer border border-gray-300"
                >
                  Cancel
                </button>
                <button className="px-4 py-2 w-full rounded-xl cursor-pointer bg-Background-Primary-Defult text-white">
                  Reschedule
                </button>
              </div>
            </>
          ...
          {filter === "past" && (
            <>
              <div className="flex gap-2 mt-2">
                <button className="px-4 py-2 rounded-xl w-full cursor-pointer border border-gray-300">
                  View details
                </button>
                <button
                  onClick={() => navigate("/AddReview")}
                  className="px-4 py-2 rounded-xl w-full cursor-pointer  bg-Background-Primary-Defult text-white"
                >
                  Feedback
                </button>
              </div>
          ...
          {filter === "canceled" && (
            <>
              <div className="flex gap-2 mt-2">
                <button
                  onClick={() =>
                    navigate(`/doctorDetails/${appointment.doctor.id}`)
                  }
                  className="px-4 py-2 rounded-xl w-full cursor-pointer border border-gray-300"
                >
                  Book again
                </button>
                <button className="px-4 py-2 rounded-xl w-full cursor-pointer bg-Background-Primary-Defult text-white">
                  Support
                </button>
              </div>
            </>
            ...
            >
              <div className="bg-white p-6 rounded-2xl shadow-lg w-80 text-center">
                ...
                <p className="p-4 text-gray-500 text-sm">
                  Cancellation must be made at least 24 hours in advance to
                  receive a refund
                </p>
